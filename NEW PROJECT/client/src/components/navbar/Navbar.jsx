    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/useroom">Rooms</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href='/usergellary'>Gellary</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href='/userblog'>Blogs</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href='/usercontact'>Contact</a>
          </li>
          <li class="nav-item">
